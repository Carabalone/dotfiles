...
" Define conceal feature
setlocal conceallevel=1

" Enable concealing for these syntax groups
highlight link coqNat Conceal
highlight link coqInt Conceal
highlight link coqForall Conceal
highlight link coqExists Conceal
highlight link coqArrow Conceal
highlight link coqGreaterEqual Conceal
highlight link coqLessEqual Conceal
highlight link coqAnd Conceal
highlight link coqOr Conceal
highlight link coqNot Conceal

syn cluster coqTerm add=coqprime

syntax keyword coqprime nat conceal cchar=ℕ
syntax keyword coqprime int conceal cchar=ℤ
syntax keyword coqprime forall conceal cchar=∀
syntax keyword coqprime exists conceal cchar=∃
syntax match coqprime "->" conceal cchar=→
syntax match coqprime ">=" conceal cchar=≥
syntax match coqprime "<=" conceal cchar=≤
syntax match coqprime "/\\" conceal cchar=∧
syntax match coqprime "\\/" conceal cchar=∨
syntax match coqprime "=>" conceal cchar=⇒
syntax keyword coqprime pi conceal cchar=π
syntax keyword coqprime lambda conceal cchar=λ
syntax keyword coqprime fun conceal cchar=λ
